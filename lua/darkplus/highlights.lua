local highlights = {
        ...
        DiffText = {bg = C.app_diff_text, fg = C.app_bg, },
        DiffAdd = {bg = C.app_diff_add, fg = C.app_bg, },
        DiffChange = {bg = C.app_diff_change, fg = C.app_bg, },
        DiffDelete = {bg = C.app_diff_delete, fg = C.app_bg,  },
